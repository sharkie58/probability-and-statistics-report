...
The script for the hypothesis testing is available in Appendix 2.

## Regression Modelling

An 80-20 split was performed on the data to obtain a training and testing dataset, and to have the opportunity to adequately estimate true model performance on test data.
